        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <img
              src="/pengu-logo.png"
              alt="LostPengu Logo"
              className="h-12 w-12 rounded-full object-cover border border-purple-400/40 shadow-[0_0_15px_rgba(217,70,239,.45)]"
            />
          ...
          <button className="rounded-full bg-gradient-to-r from-purple-600 to-pink-500 px-7 py-3 font-bold shadow-[0_0_25px_rgba(217,70,239,.55)]">
            Coming Soon
          </button>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-32 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-5">
            ...
            <button className="rounded-full bg-gradient-to-r from-purple-600 to-pink-500 px-10 py-4 font-bold shadow-[0_0_30px_rgba(217,70,239,.55)]">
              Buy on Pump.fun
            </button>

            <button className="rounded-full border border-purple-300/30 bg-black/30 px-10 py-4 font-bold backdrop-blur-md">
              Launch AI Terminal
            </button>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 md:grid-cols-[420px_1fr]">
          ...
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-9 text-gray-300">
              ...
              Its story explains how LostPengu entered this world,
              why it started observing blockchain behavior,
              and how it evolved into a self coding AI agent.

              <br />
              <br />

              From that origin,
              the first system was born:
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-300">
              Analyze wallets, detect social exposure and explore
              the experimental LostPengu AI system.
            </p>
